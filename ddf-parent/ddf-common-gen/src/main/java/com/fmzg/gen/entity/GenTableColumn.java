...
public class GenTableColumn extends BaseEntity<GenTableColumn>{
	...
	private String isInsert = "1";	// 是否为插入字段（1：插入字段）
	private String isEdit = "1";		// 是否编辑字段（1：编辑字段）
	private String isList = "1";		// 是否列表字段（1：列表字段）
	private String isQuery = "1";		// 是否查询字段（1：查询字段）
	...
	public Boolean getIsNotBaseField(){
		return !StringUtils.equals(getSimpleJavaField(), "id")
				&& !StringUtils.equals(getSimpleJavaField(), "remark")
