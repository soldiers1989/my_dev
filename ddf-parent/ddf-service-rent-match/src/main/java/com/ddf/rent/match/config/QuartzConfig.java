package com.ddf.rent.match.config;
...
import com.ddf.rent.match.factory.MyJobFactory;
import com.ddf.rent.match.job.RentMatchJob;
...
public class QuartzConfig {
	...
	// 配置文件路径  
    static final String QUARTZ_CONFIG = "quartz/quartz.properties";  
  
    // 定时任务组名称  
    public static final String Quartz_Group_Name = "rent_match";  
    //定时任务方法后缀  
    ...
    {  
        ...
        l.add(createTrigger(RentMatchJob.class, "0/20 * * * * ?"));  
    ...
    {  
        ...
        // FileSystemResource(this.getClass().getResource("/job.properties").getPath()));
        return factory;  
    }  
