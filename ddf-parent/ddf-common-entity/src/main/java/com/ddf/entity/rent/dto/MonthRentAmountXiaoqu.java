...
/**
 * month_rent_amount_xiaoqu Entity
 * @author robot
 * @version 2018-01-26
 */
@ApiModel(description = "MonthRentAmountXiaoqu")
public class MonthRentAmountXiaoqu extends DataEntity {
	
	private static final long serialVersionUID = 1L;
	@ApiModelProperty(value = "xiaoqu_id")
	private String xiaoquId;
	@ApiModelProperty(value = "xiaoqu_name")
	...
	public MonthRentAmountXiaoqu() {
		super();
	}

	public MonthRentAmountXiaoqu(String id){
		super(id);
	}
