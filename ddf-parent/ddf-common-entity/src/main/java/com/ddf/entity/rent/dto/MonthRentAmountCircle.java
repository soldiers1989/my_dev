...
/**
 * month_rent_amount_circle Entity
 * @author robot
 * @version 2018-01-26
 */
@ApiModel(description = "MonthRentAmountCircle")
public class MonthRentAmountCircle extends DataEntity {
	
	private static final long serialVersionUID = 1L;
	@ApiModelProperty(value = "circle_id")
	private String circleId;
	@ApiModelProperty(value = "circle_name")
	...
	public MonthRentAmountCircle() {
		super();
	}

	public MonthRentAmountCircle(String id){
		super(id);
	}
